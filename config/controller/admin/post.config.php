...
$datas = array(
    ...
    'messages' => array(
        ...
        'exists in multiple site' => __('This post exists in <strong>{count} sites</strong>.'),
        'delete in the following sites' => __('Delete this post in the following sites:'),
        'item deleted' => __('This post has been deleted.'),
        'not found' => __('Post not found'),
        'error added in site' => __('This post cannot be added {site}.'),
        'item inexistent in site yet' => __('This post has not been added in {site} yet.'),
        'add an item in site' => __('Add a new post in {site}'),
