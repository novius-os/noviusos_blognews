...
return array (
    ...
    'messages' => array(
        ...
        'exists in multiple site' => __('This category exists in <strong>{count} sites</strong>.'),
        'delete in the following sites' => __('Delete this category in the following sites:'),
        'item deleted' => __('This category has been deleted.'),
        'not found' => __('category not found'),
        'error added in site not parent' => __('This category cannot be added {site} because its {parent} is not available in this site yet.'),
        'error added in site' => __('This category cannot be added {site}.'),
        'item inexistent in site yet' => __('This category has not been added in {site} yet.'),
        'add an item in site' => __('Add a new category in {site}'),
    ),
    'tab' => array(
