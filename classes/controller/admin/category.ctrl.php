...
class Controller_Admin_Category extends \Nos\Controller_Admin_Crud {
    ...
    public function before()
    {
        ...
        $this->config                       = \Arr::merge($this->config,\Config::get('noviusos_blognews::controller/admin/category'), \Config::loadConfiguration($application_name, 'controller/admin/category'));
