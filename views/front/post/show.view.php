<div class="post">
    ...
    <?= \View::forge('noviusdev_blognews::front/post/content', array('item' => $item)) ?>
...
<?php if ($app_config['comments']['enabled']) { ?>
    <div class="comments" id="comments">
        ...
        <?php if ($app_config['comments']['show']) { ?>
            <?= \View::forge('noviusdev_comments::front/list', array('comments' => $item->comments), true) ?>
        <?php } ?>
        <?php if ($app_config['comments']['can_post']) { ?>
            <?= \View::forge('noviusdev_comments::front/form', array('add_comment_success' => $add_comment_success, 'use_recaptcha' => $app_config['comments']['use_recaptcha']), true) ?>
        <?php } ?>
    </div>
<?php } ?>
</div>