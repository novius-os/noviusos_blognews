...
return array(
    ...
    #: classes/controller/front.ctrl.php:85
    #: classes/controller/front.ctrl.php:177
    'Posts list' => 'Liste del posts',

    #: classes/controller/front.ctrl.php:87
    #: classes/controller/front.ctrl.php:231
    'Comments list' => 'Liste del comentas',
    ...
    'Blog posts listed under the ‘{{category}}’ category.' => 'Posts de blog del categorie ‘{{category}}’',

    #: classes/controller/front.ctrl.php:191
    #: classes/controller/front.ctrl.php:289
    '{{tag}}: Posts list' => '{{tag}}: Liste del posts',
    ...
    'Comments to the post ‘{{post}}’.' => 'Comentas del post «&nbsp;{{post}}&nbsp;».',
