...
return array(
    ...
    'Blog posts listed under the ‘{{category}}’ category.' => 'Посты блога в категории «{{category}}».',

    #: classes/controller/front.ctrl.php:191
    #: classes/controller/front.ctrl.php:289
    '{{tag}}: Posts list' => '{{tag}}: Список постов',
    ...
    'Comments to the post ‘{{post}}’.' => 'Комментарии к посту «{{post}}».',
    ...
    'Categories: {{categories}}' => 'Категории: {{categories}}',
